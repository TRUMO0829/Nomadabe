...
export const DEFAULT_ABOUT_SECTION: AboutSectionSettings = {
  mn: {
    ...
    title: "дэлхий рүү холбодог аяллын баг",
    body:
      "Nomadabe Travel нь бизнес болон дотоод, гадаад аяллаар мэргэшсэн аяллын компани бөгөөд 10,000 гаруй аялагчийн аяллыг амжилттай зохион байгуулсан туршлагатай.",
    navigation: [
    ...
    work: {
      ...
      title: "Business, leisure, custom аяллыг нэг дор зохион байгуулдаг.",
      body:
      ...
      items: [
        {
          ...
          body: "Олон улсын үзэсгэлэн, уулзалт, салбарын арга хэмжээ, зах зээл судлах аяллыг зохион байгуулна.",
          order: 1,
          isVisible: true,
        },
        {
          title: "Leisure Tours",
          body: "Монгол болон гадаад чиглэлийн амралт, хот, байгаль, соёлын аяллыг төлөвлөнө.",
          order: 2,
          isVisible: true,
        },
        {
          title: "Customized Tours",
          body: "Гэр бүл, найз нөхөд, байгууллагын зорилгод тохирсон захиалгат маршрутыг гаргана.",
          order: 3,
          isVisible: true,
        },
        {
          title: "Inbound + Outbound",
          body: "Монголд ирэх болон Монголоос гадагш аялах чиглэлийг нэг баг гүйцэтгэнэ.",
          order: 4,
          isVisible: true,
        },
      ],
