...
const SECTION_COPY = {
  mn: {
    ...
    all: "Бүх аялал",
    outbound: "Олон улсын аяллууд",
    domestic: "Монгол орноор аялах",
    corporate: "Байгууллагын аялал",
    villa: "Вилла",
    directions: "Олон улсын аяллууд",
    categoryTitle: "Аяллын категори",
    outboundDirection: "Олон улсын аяллууд",
    domesticDirection: "Монгол орноор аялах",
